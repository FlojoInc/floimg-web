...
await floimg.save(chart, "./quarterly-chart.png");`,
  ...
  params: {
    ...
    links: {
      ...
      github: "https://github.com/FlojoInc/FloImg/tree/main/packages/floimg-quickchart",
...
await floimg.save(diagram, "./architecture.png");`,
  ...
  params: {
    ...
    links: {
      ...
      github: "https://github.com/FlojoInc/FloImg/tree/main/packages/floimg-mermaid",
...
await floimg.save(qrCode, "./website-qr.png");`,
  ...
  params: {
    ...
    links: {
      ...
      github: "https://github.com/FlojoInc/FloImg/tree/main/packages/floimg-qr",
...
await floimg.save(capture, "./github-screenshot.png");`,
  ...
  params: {
    ...
    links: {
      ...
      github: "https://github.com/FlojoInc/FloImg/tree/main/packages/floimg-screenshot",
...
await floimg.save(viz, "./framework-usage.png");`,
  ...
  params: {
    ...
    links: {
      ...
      github: "https://github.com/FlojoInc/FloImg/tree/main/packages/floimg-d3",
...
await floimg.save(image, "./futuristic-city.png");`,
  ...
  params: {
    ...
    links: {
      ...
      github: "https://github.com/FlojoInc/FloImg/tree/main/packages/floimg-openai",
...
await floimg.save(image, "./robot-mascot.png");`,
  ...
  params: {
    ...
    links: {
      ...
      github: "https://github.com/FlojoInc/FloImg/tree/main/packages/floimg-ollama",
...
await floimg.save(noBg, "./city-no-bg.png");`,
  ...
  provider: "stability-transform"
    ...
    links: {
      ...
      github: "https://github.com/FlojoInc/FloImg/tree/main/packages/floimg-stability",
...
const analysis = await floimg.analyzeImage({
  ...
  params: { prompt: "What's in this image?" }
    ...
    links: {
      ...
      github: "https://github.com/FlojoInc/FloImg/tree/main/packages/floimg-google",
...
const upscaled = await floimg.transform({
  ...
  params: { renderFactor: 35 }
    ...
    links: {
      ...
      github: "https://github.com/FlojoInc/FloImg/tree/main/packages/floimg-replicate",
...
const analysis = await floimg.analyzeImage({
  ...
  params: { prompt: "What product is shown?" }
    ...
    links: {
      ...
      github: "https://github.com/FlojoInc/FloImg/tree/main/packages/floimg-xai",
