...
**Prompt:**
> "Create an Open Graph image for my blog post titled 'Building Scalable APIs' with a purple gradient background"
...
```json
{
  ...
  "params": {
    ...
    "params": {
      "html": "<div style=\"width:1200px;height:630px;background:linear-gradient(135deg,#7c3aed,#a855f7);display:flex;align-items:center;justify-content:center;font-family:system-ui;color:white;\"><h1 style=\"font-size:64px;text-align:center;padding:40px;\">Building Scalable APIs</h1></div>",
      "width": 1200,
      "height": 630
    },
    "output": "og-image.png"
