...
>
> This plugin integrates with Ollama running locally—no cloud API, no data leaves your machine.
> See the [Ollama documentation](https://ollama.ai/) for available models.
