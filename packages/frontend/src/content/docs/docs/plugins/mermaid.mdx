...
>
> Your diagram syntax is native Mermaid—[no FloImg abstraction layer](/docs/plugins#how-plugins-work).
> See their [syntax docs](https://mermaid.js.org/intro/) for all diagram types.
