...
>
> Your render function has full access to D3's API—[no FloImg abstraction layer](/docs/plugins#how-plugins-work).
> See the [D3 documentation](https://d3js.org/) and [D3 gallery](https://observablehq.com/@d3/gallery) for examples.
