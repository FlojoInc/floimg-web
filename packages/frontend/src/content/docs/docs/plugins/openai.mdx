...
> **Powered by [OpenAI DALL-E](https://openai.com/dall-e-3) and [GPT-4 Vision](https://platform.openai.com/docs/guides/vision)**
>
> This plugin exposes the full power of OpenAI's APIs—[no FloImg abstraction layer](/docs/plugins#how-plugins-work).
> See the [OpenAI API docs](https://platform.openai.com/docs/api-reference/images) for all options.
